 ...
 *
 * Disassembly of dsdt.aml, Mon May  1 21:52:39 2017
 *
                ...
                Method (EVBC, 0, Serialized)
                {
                    ...
                    While (One)
                    {
                        ...
                        If (_T_0 == One)
                        {
                            ...
                            ElseIf ((Local1 > 0x60) && (Local1 < 0x70))
                            {
                                If (Local1 == 0x63)
                                {
                ...
                Method (WMAA, 3, NotSerialized)
                {
                    ...
                    If (Arg1 == One)
                    {
                        ...
                        Else
                        {
                            If (Arg1 == One)
                            {
                                Local1 = DerefOf (Arg2 [Zero])
                                Local2 = DerefOf (Arg2 [One])
                                If (Local1 == 0x05)
                                {
                                    If (Local2 == 0x02)
                                    {
    ...
    Method (_WAK, 1, Serialized)  // _WAK: Wake
    {
        ...
        If ((Arg0 == 0x03) || (Arg0 == 0x04))
        {
            ...
            If ((BID == BICO) || (BID == BICC))
            {
                ...
                REG6 = 0x00F0F000
                Local2 = \_GPE.MMTB /* External reference */
                \_GPE.OSUP (Local2)
                REG6 = Local1
                Release (OSUM)
            }
            ...
            ElseIf ((\_SB.PCI0.LPCB.EC0.ECPF == 0x30) || (\_SB.PCI0.LPCB.EC0.ECPF == 0x31)) {}
            Else
            {
