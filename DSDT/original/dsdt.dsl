 ...
 *
 * Disassembly of iASLQkfrjn.aml, Mon May  8 13:20:07 2017
 *
...
DefinitionBlock ("", "DSDT", 1, "ACRSYS", "ACRPRDCT", 0x00000000)
{
    ...
    External (_SB_.PCI0.GFX0.BLM0, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.GFX0.BLM1, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.GFX0.BLM2, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.GFX0.BLM3, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.GFX0.BLM4, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.GFX0.BLM5, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.GFX0.BLM6, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.GFX0.BLM7, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.GFX0.BLM8, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.GFX0.BLM9, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.GFX0.BLMX, UnknownObj)    // Warning: Unknown object
    ...
    External (_SB_.PCI0.RP05.PEGP.DD01, UnknownObj)    // Warning: Unknown object
    ...
    Method (_WAK, 1, Serialized)  // _WAK: Wake
    {
        ...
        If (LEqual (\_SB.WFVD, One))
        {
            If (And (ICNF, 0x10))
            {
                If (And (\_SB.PCI0.GFX0.TCHE, 0x0100))
                {
                    ...
                    {
                        If (LAnd (And (\_SB.PCI0.LPCB.EC0.ECRD (RefOf (\_SB.PCI0.LPCB.EC0.IBT1)), One), LOr (And (\_SB.IAOE.WKRS, 0x02), And (\_SB.IAOE.WKRS, 0x10))))
                        {
                            Store (Or (And (\_SB.PCI0.GFX0.STAT, 0xFFFFFFFC), One), \_SB.PCI0.GFX0.STAT)
                        }
                        Else
        ...
        If (LOr (LEqual (Arg0, 0x03), LEqual (Arg0, 0x04)))
        {
            ...
            ElseIf (LOr (LEqual (\_SB.PCI0.LPCB.EC0.ECPF, 0x30), LEqual (\_SB.PCI0.LPCB.EC0.ECPF, 0x31))) {}
            Else
            {
